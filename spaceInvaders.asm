...
LEFT_BUTTON		EQU	P1.0
RIGHT_BUTTON	EQU	P1.1
FIRE_BUTTON		EQU	P1.2
...
;ADEUS XRL E ORL
;LEFT_B  	    EQU 11111101B  ;PX.0 LEFT
;RIGHT_B         EQU 11111011B  ;PX.1 RIGHT
;FIRE_B          EQU 11111110B  ;PX.2 FIRE
	;MOV A, R0
	;ORL A, #11111110B
	;XRL A, #FIRE_B
	;JZ PLAYER_SHOOTING
