...
TODOS 		BIT		21H	;QUANDO ESTÁ EM UM INDICA QUE DEVE ESCREVER NOS DOIS LADOS
...
UMA_VIDA:
	...
	RET
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;; FIM DA FUNÇAO QUE LIGA OS LEDS DE ACORDO COM AS VIDAS ;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
ITS_GAME_OVER_MAN:
	CLR TR0	;;PARA DE CONTAR O TIMER TAMBÉM, NÃO TEM MAIS INTERRUPÇÕES
...
;;;;;;;;;;;;;;;;;;;;;;;;  FUNÇAO QUE MOVE OS INIMIGOS NA MEMÓRIA E ESCREVE NO LCD ;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
MOVE_INIMIGOS:
	CALL MOVE_MEMORIA_INIMIGOS
	CALL MOVE_TODOS_OS_INIMIGOS_VIVOS
	RET
;;;;;;;;;;;;;;;;;;;;;;;;;;; FIM DA FUNÇÃO QUE MOVE OS INIMIGOS TOTALMENTE ;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
DEFINE_BORDAS_X_INIMIGOS:
	...
	MOV R1, #NUMERO_INIMIGOS	;NUMERO_INIMIGOS É UMA CTE = 8 (DECIMAL)
	MOV R0, #ENEMIES
ONE_MORE_ENEMY_LALA:	
	MOV A, @R0
	XRL A, #0FFH			;;JÁ ESTA MORTO
	...
	MOV A,@R0			   ; SERÁ O MENOR?
	SUBB A, MENOR_X					;SUBTRAI O X ATUAL DO MENOR_X , SE NÃO DER CARRY É POR QUE O X ATUAL É MENOR
	JC ESSE_EH_MENOR

	MOV A, @R0				; SE NAO, SERÁ O MAIOR???
	SUBB A, MAIOR_X
	JNC ESSE_EH_MAIOR
...
BORDA_PROXIMO_INIMIGO:
	...
	JNZ	VOLTA_BORDAS
	MOV MAIOR_X, MENOR_X
VOLTA_BORDAS: ;NAO EH UTILIZA, INDICA FIM DA FUNCAO	
	POP AR2
	POP AR1
	POP AR0
 	RET	 
...
;;;;;;;;;;;; FUNCAO QUE APAGA O TIRO QUANDO ELE ALCANÇA O CHAO;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;; RECEBE EM A O Y CORRETO, LCD JÁ NO X CERTO
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
LIMPA_LINHA_ANT:
	 PUSH AR1
