...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AGORA O BIXO VAI PEGAR:
	...
	;COISA NÃO DEFINIDAS QUE ME IMPEDEM DE COMPILAR ESSA OBRA DE ARTE
	NAVE_X DATA 030H
	LINHA_LCD DATA 07FH
	;OH. MEU. DEUS. AGORA COMPILA!
	
	STARTINGX EQU 114D ; max = 116
	STARTINGY EQU 0D
...
LEFT_B  	    EQU 11111110B  ;PX.0 LEFT
RIGHT_B         EQU 11111101B  ;PX.1 RIGHT
FIRE_B          EQU 11111011B  ;PX.2 FIRE
	...
	JZ CHECK_FIRE
	CALL DEBOUNCE
	;descobre qual o botão foi apertado
	MOV A, R0
	XRL A, #FIRE_B
	JZ PLAYER_SHOOTING
	MOV A, R0
...
MOVE_NAVE:
	...
	MOV A, NAVE_X;A FICA COM A POSIÇÃO x DA NAVE
	CALL TRADUZ_X	;;A FICA COM A POSIÇÃO X CORRETA DA NAVE, E O BIT SELECT FICA APROPRIADO
	CALL DESENHA_NAVE  ;; DESENHA A NAVE NO NOVO LUGAR DA TELA
	RET
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
